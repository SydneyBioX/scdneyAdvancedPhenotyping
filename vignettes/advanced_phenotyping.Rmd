...
We will use the dataset from [this paper](https://www.nature.com/articles/s41586-018-0414-6#additional-information). We provide the preprocessed version in this workshop. The original data can be access from GEO with the accession number XXXXXX.
...
#### Saving outputs
Finally, we can save our marker gene analysis for use later. 
```{r}
